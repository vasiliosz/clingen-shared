...
#PLOT OUTPUT FROM taps_plot() (can be adjusted for plotting output from taps_call()). For a specific

#set variables
combined_log2_baf <- TRUE
log2limits <- c(-1,1) # Set limits for log2 scale: points outside this interval will be squished at limits
chr <- "chr7" # Select a chromosome to plot. TODO(VZ): Select specific coordinates
